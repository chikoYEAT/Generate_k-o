...
#include "FirstProj/MyPawn.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyPawn() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_APawn();
	FIRSTPROJ_API UClass* Z_Construct_UClass_AMyPawn();
	FIRSTPROJ_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
...
// End Cross Module References
	...
	template<> FIRSTPROJ_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyPawn);
	AMyPawn::~AMyPawn() {}
	struct Z_CompiledInDeferFile_FID_game_files_FirstProj_5_3_Source_FirstProj_MyPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_game_files_FirstProj_5_3_Source_FirstProj_MyPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyPawn, AMyPawn::StaticClass, TEXT("AMyPawn"), &Z_Registration_Info_UClass_AMyPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyPawn), 3952242885U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_game_files_FirstProj_5_3_Source_FirstProj_MyPawn_h_3191592514(TEXT("/Script/FirstProj"),
		Z_CompiledInDeferFile_FID_game_files_FirstProj_5_3_Source_FirstProj_MyPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_game_files_FirstProj_5_3_Source_FirstProj_MyPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
